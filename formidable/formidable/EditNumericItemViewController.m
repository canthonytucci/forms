//
//  EditNumericItemViewController.m
//  formidable
//
...
@interface EditNumericItemViewController ()

@end

@implementation EditNumericItemViewController
...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (textField == _labelTextField) {
        ...
        [_delegate didChangeNumericItemAtIndexPath:_indexPathForTheItem withValue:newString forKey:@"label"];
    } else if (textField == _placeholderTextField) {
        [_theItem setValue:newString forKey:@"placeholder"];
        [_delegate didChangeNumericItemAtIndexPath:_indexPathForTheItem withValue:newString forKey:@"placeholder"];
    } else if (textField == _initialValueTextField) {
        [_theItem setValue:newString forKey:@"value"];
        [_delegate didChangeNumericItemAtIndexPath:_indexPathForTheItem withValue:newString forKey:@"value"];
    } else if (textField == _maximumValueTextField) {
        [_theItem setValue:newString forKey:@"max"];
        [_delegate didChangeNumericItemAtIndexPath:_indexPathForTheItem withValue:newString forKey:@"max"];
    }
    return YES;
